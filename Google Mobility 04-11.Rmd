...
# linear model fit with transformed predictors
...
plot(google.fulltrans)
plot(google.workplace)
...
Choose between $|r_i|>3\;or\;2$ Setting it to 3 means there are no outliers
```{r}
# outlier calculations
cacovid_std <- rstandard(regsubset.trans1)
which(abs(cacovid_std) > 3)
