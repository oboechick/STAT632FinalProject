...
We ran a basic ANOVA to make sure that there was at least one sgnificant variable in our model. We accordingly can now reject the null hypothesis and assume that there is at least one significant predictor in this model.
...
### Appendix 3: World Bank Data Story
