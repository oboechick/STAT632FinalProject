...
This data set is a collection of governmental sources at national, regional, and city levels from 190 countries for COVID19. It includes time series of vaccines, test, cases, deaths, recovered, intensive therapy, and policy measures by Oxford COVID-19 Government Response Tracker. We will also be using the World Bank Open Data and Google Mobility Reports as well.

We will be limiting the location data strictly to California and using data from 3/15/2020 - 3/15/2021. There are 16 variables in what we are calling the base data set that we will be using for our regression. Eight of these 16 variables are 2 or 3 level factors. We will be using date, confirmed, tests, latitude , longitude, population,  fschool_closing, fworkplace_closing, fgatherings_restrictions, fstay_home_restrictions, finternal_movement_restrictions, finformation_campaigns, ftesting_policy, fcontact_tracing, and stringency_index.

For the google mobility data we will be adding __, __, __, and __.

For the World Bank data we will be adding __ and __.
