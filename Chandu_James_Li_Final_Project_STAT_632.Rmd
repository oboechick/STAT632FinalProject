...
#### b) Full Model (Google Mobility Numerical Variables only)
...
$\sqrt{deaths} = \beta_0+\beta_1retail\;and\;recreation\;percent\;change\;from\;baseline^2+\beta_2\sqrt{grocery\;and\;pharmacy\;percent\;change\;from\;baseline}+\beta_3log(parks\;percent\;change\;from\;baseline)+\beta_4log(transit\;stations\;percent\;change\;from\;baseline)+\beta_5workplaces\;percent\;change\;from\;baseline+\beta_6residential\;percent\;change\;from\;baseline)^-2$
