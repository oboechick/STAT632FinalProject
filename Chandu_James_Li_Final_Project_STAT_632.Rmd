...
#### a) Full Model (Base Covid + Google Mobility)
...
We come to the conclusion that this model explains 43.11% of the variability seen in the number of California Covid deaths. 

A one unit increase in people going to areas of $retail\;and\;recreation^2$ with the other predictors held fixed is associated with an increase in $\sqrt{deaths}$ by 347.54. 

A one unit increase in people going to areas of $\sqrt{grocery\;and\;pharmacy}$ with the other predictors held fixed is associated with an increase in $\sqrt{deaths}$ by -536.45. 

A one unit increase in people going to areas of $log(parks)$ with the other predictors held fixed is associated with an increase in $\sqrt{deaths}$ by -15.92. 

A one unit increase in people going to areas of $log(transit\;stations)$ with the other predictors held fixed is associated with an increase in $\sqrt{deaths}$ by -44.96. 

A one unit increase in people going to areas of workplaces with the other predictors held fixed is associated with an increase in $\sqrt{deaths}$ by -55.11. 

A one unit increase in people going to areas of $residential^-2$ with the other predictors held fixed is associated with an increase in $\sqrt{deaths}$ by 392.19. 
