...
```{r}
(step_aic <- step(mod.0, scope = list(lower = mod.0, upper = mod.full1), trace = 0))
```

```{r}
(step_aic <- step(mod.0, scope = list(lower = mod.0, upper = mod.full2), trace = 0))
```
...
```{r}
(step_bic <- step(mod.0, scope = list(lower = mod.0, upper = mod.full1), trace = 0))
```

```{r}
(step_bic <- step(mod.0, scope = list(lower = mod.0, upper = mod.full2), trace = 0))
```
...
```{r}
step_aicfull <- (step_aicfull <- step(mod.full))
```
