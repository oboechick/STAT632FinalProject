...
```{r}
fit <- lm(deaths ~ date + confirmed + deaths + tests + latitude  + longitude + population +  fschool_closing +
            fworkplace_closing + fcancel_events + fgatherings_restrictions + ftransport_closing + 
            fstay_home_restrictions + finternal_movement_restrictions + finternational_movement_restrictions +
            finformation_campaigns + ftesting_policy + fcontact_tracing + stringency_index, data = base_data)
```
